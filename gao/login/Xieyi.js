    ...
    render(){
        ...
        <SafeAreaView style={{flex:1,}}>
            ...
            contentContainerStyle={{alignItems:'center'}} >
              <Text style={{fontSize:18,color:'#212F3C',marginTop:20}}>
              User agreement
              </Text>
...
(c) Violation of the law or the application rules and the measures taken by the application to you.
2. Information Use
...
(c) For the purpose of serving users, the application may use your personal information to provide you with information of interest, including, but not limited to, products and services, or to share information with the application partners so that they can send you information about their products and services (the latter requires your prior agreement). I mean.
...
(b) When using this application network service for online trading, you will inevitably have to deal with the counterparty or potential trading pair.
7. Changes in the Privacy Policy
(a) If we decide to change our privacy policy, we will be in the right place in this policy, on our website and in our opinion.
